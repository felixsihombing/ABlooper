...
train_losses, val_losses = train_model_refine(model, optimiser, train_dataloader, val_dataloader, training_name='-1705-refine-1-1' , n_epochs=5000, patience=100, decoys=1)
