...
pdb_ids, CDR_rmsds_not_relaxed, CDR_rmsds_relaxed, decoy_diversities, CDR_rmsds_not_relaxed_recalc = produce_full_structures_of_val_set(test_dataloader, model, outdir='0305-Radam-1-2optim-test', relax=True)
