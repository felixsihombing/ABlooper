...
train_losses, val_losses = train_model_2optim(model, optimiser1, optimiser2, train_dataloader, val_dataloader, training_name='-0305-Radam-1-2optim-3' , n_epochs=5000, patience=100, decoys=1)
